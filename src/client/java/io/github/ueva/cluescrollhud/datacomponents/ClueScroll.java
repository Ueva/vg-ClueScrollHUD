...
public record ClueScroll(String tier, int created, int expire, List<ClueTask> clues) {
    ...
    public static final Codec<ClueScroll> CODEC = RecordCodecBuilder.create(instance -> instance.group(
            Codec.STRING.fieldOf("tier").forGetter(ClueScroll::tier),
            Codec.INT.fieldOf("amount").forGetter(ClueScroll::created),
            Codec.INT.fieldOf("completed").forGetter(ClueScroll::expire),
            ClueTask.CODEC.listOf().fieldOf("clues").forGetter(ClueScroll::clues)
